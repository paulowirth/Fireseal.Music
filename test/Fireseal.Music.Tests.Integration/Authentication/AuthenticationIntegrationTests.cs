...
namespace Fireseal.Music.Tests.Integration.Authentication;

public class AuthenticationIntegrationTests(FiresealApplicationFactory factory, ITestOutputHelper testOutputHelper) 
